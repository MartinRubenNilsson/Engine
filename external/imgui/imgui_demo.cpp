...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // Most functions would normally just crash if the myContext is missing.
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        // This is useful in particular if you want to create a myContext menu associated to the title bar of a window.
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        {
            // Demonstrate a trick: you can use Begin to set yourself in the myContext of another window
...
static void ShowDemoWindowTables()
{
    ...
    // Demonstrate creating custom myContext menus inside columns, while playing it nice with myContext menus provided by TableHeadersRow()/TableHeader()
    if (open_action != -1)
        ImGui::SetNextItemOpen(open_action != 0);
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        // [1.1] Right-click on the TableHeadersRow() line to open the default table myContext menu.
        // [1.2] Right-click in columns also open the default table myContext menu (if ImGuiTableFlags_ContextMenuInBody is set)
        const int COLUMNS_COUNT = 3;
        ...
        // [2.1] Right-click on the TableHeadersRow() line to open the default table myContext menu.
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // Here we create a myContext menu only available from the title bar.
        if (ImGui::BeginPopupContextItem())
        {
...
// + a myContext-menu to choose which corner of the screen to use.
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("Canvas"))
        {
            ...
            // Pan (we use a zero mouse threshold when there's no myContext menu)
...
struct MyDocument
{
    ...
    // Display myContext menu for the Document
